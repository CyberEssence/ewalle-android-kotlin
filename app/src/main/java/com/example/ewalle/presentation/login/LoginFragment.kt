...
import com.example.ewalle.presentation.main.LoginFragmentInteractor

class LoginFragment : BaseFragment() {

    private var fragmentInteractor: LoginFragmentInteractor? = null
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is LoginFragmentInteractor) {
